...
import { Search, ShoppingCart, MessageCircle, Plus, X } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <header className="p-4 border-b border-slate-800 flex justify-between items-center sticky top-0 bg-[#0f172a]/90 backdrop-blur-md z-50">
        <h1 className="text-xl font-black text-blue-500 italic uppercase tracking-tighter">BREKART</h1>
